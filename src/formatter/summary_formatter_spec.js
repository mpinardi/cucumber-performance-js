  ...
  describe('features', () => {
    ...
    describe('with a failing scenario', () => {
      beforeEach(function() {
        ...
        this.result.groups[0].testCases[0].steps[0].issues = [{exception:'error', cnt: 10,status: Status.FAILED}]
        this.result.groups[0].testCases[0].steps[0].sourceLocation= {uri: 'a.feature', line: 3}
        this.result.groups[0].testCases[0].sourceLocation= {uri: 'a.feature', line: 2}
        this.result.groups[0].testCases[0].steps[0].actionLocation= {uri: 'steps.js', line: 4}
        this.eventBroadcaster.emit('simulation-statistics-finished', this.result)
      })
    ...
    describe('with an ambiguous step', () => {
      beforeEach(function() {
        ...
        this.result.groups[0].hasIssues = true
        this.result.groups[0].testCases[0].hasIssues = true
        this.result.groups[0].testCases[0].steps[0].issues = [{exception:'Multiple step definitions match:\n' +
        '  pattern1        - steps.js:3\n' +
        '  longer pattern2 - steps.js:4', cnt: 5, status: Status.AMBIGUOUS}]
        this.result.groups[0].testCases[0].steps[0].sourceLocation= {uri: 'a.feature', line: 3}
        this.result.groups[0].testCases[0].sourceLocation= {uri: 'a.feature', line: 2}
        this.result.groups[0].testCases[0].steps[0].actionLocation= {uri: 'steps.js', line: 4}
        this.eventBroadcaster.emit('simulation-statistics-finished', this.result)
    ...
    describe('with an undefined step', () => {
      beforeEach(function() {
        ...
        this.result.groups[0].hasIssues = true
        this.result.groups[0].testCases[0].hasIssues = true
        this.result.groups[0].testCases[0].steps[0].issues = [{cnt: 20, status: Status.UNDEFINED}]
        this.result.groups[0].testCases[0].steps[0].sourceLocation= {uri: 'a.feature', line: 3}
        this.result.groups[0].testCases[0].sourceLocation= {uri: 'a.feature', line: 2}
        this.result.groups[0].testCases[0].steps[0].actionLocation= {uri: 'steps.js', line: 4}
        this.eventBroadcaster.emit('simulation-statistics-finished', this.result)
    ...
    describe('with a pending step', () => {
      beforeEach(function() {
        ...
        this.result.groups[0].hasIssues = true
        this.result.groups[0].testCases[0].hasIssues = true
        this.result.groups[0].testCases[0].steps[0].issues = [{cnt: 20, status: Status.PENDING}]
        this.result.groups[0].testCases[0].steps[0].sourceLocation= {uri: 'a.feature', line: 3}
        this.result.groups[0].testCases[0].sourceLocation= {uri: 'a.feature', line: 2}
        this.result.groups[0].testCases[0].steps[0].actionLocation= {uri: 'steps.js', line: 4}
        this.eventBroadcaster.emit('simulation-statistics-finished', this.result)
